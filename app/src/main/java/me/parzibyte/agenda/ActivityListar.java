...
public class ActivityListar extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ConexionSQLiteHelper conexion = new ConexionSQLiteHelper(ActivityListar.this, Utileria.NOMBRE_BD, null, 1);
        SQLiteDatabase bd = conexion.getReadableDatabase();
        String[] campos = {Utileria.CAMPO_NOMBRE, Utileria.CAMPO_TELEFONO, Utileria.CAMPO_ID};
        ...
        do {
            String nombre = cursor.getString(cursor.getColumnIndex(Utileria.CAMPO_NOMBRE));
            String telefono = cursor.getString(cursor.getColumnIndex(Utileria.CAMPO_TELEFONO));
            int id = cursor.getInt(cursor.getColumnIndex(Utileria.CAMPO_ID));
